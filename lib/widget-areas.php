...
register_sidebars(1,
  array(
  'name' => __( 'サイドバーウイジェット', 'smooth-update' ),
  'id' => 'sidebar-1',
  'description' => __( 'サイドバーのウィジットエリアです。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( 'スクロール追従領域', 'smooth-update' ),
  'id' => 'sidebar-scroll',
  'description' => __( 'サイドバーで下にスクロールすると追いかけてくるエリアです。※モバイルでは表示されません。（ここにGoogle AdSenseを貼るのはポリシー違反です。）', 'smooth-update' ),
  'before_widget' => '<aside id="%1$s" class="widget %2$s">',
  'after_widget' => '</aside>',
  'before_title' => '<h3 class="widget_title sidebar_widget_title">',
  'after_title' => '</h3>',
...
register_sidebars(1,
  array(
  'name' => __( '広告 336x280', 'smooth-update' ),
  'id' => 'adsense-336',
  'description' => __( '「テキスト」ウィジェットを用いて、336×280pxの広告を入力してください。主にパソコン向け。（※「広告」ウィジェットは使用しないでください）', 'smooth-update' ),
  'before_widget' => '',
  'after_widget' => '',
...
register_sidebars(1,
  array(
  'name' => __( '広告 300x250', 'smooth-update' ),
  'id' => 'adsense-300',
  'description' => __( '「テキスト」ウィジェットを用いて、300×250pxの広告を入力してください。主にモバイル向け。コードはAMP広告にも使用されます。（※「広告」ウィジェットは使用しないでください）', 'smooth-update' ),
  'before_widget' => '',
  'after_widget' => '',
  'before_title' => '<div class="widget-ad">',
  'after_title' => '</div>',
...
//if ( is_ads_performance_visible() ):
  if ( !is_ads_custum_ad_space() ) {//ビッグバナーのとき
    $adw_name = __( '広告 728×90', 'smooth-update' );
    $adw_desc = __( '広告が2つしか表示されていないPC表示ページのトップにビッグバナーを表示します。「テキスト」ウィジェットを用いて728×90のビッグバナー入力推奨です。完全レスポンシブのときは設定しても表示されません。（デフォルト状態をなるべくシンプルにするためカスタマイザーから設定しないと、このウイジェット設定は表示されません。）', 'smooth-update' );
  } else {//カスタム広告の時
    $adw_name = __( '広告 custum 680×150など', 'smooth-update' );
    $adw_desc = __( '広告が2つしか表示されていないPC表示ページのトップにカスタムサイズ広告を表示します。「テキスト」ウィジェットを用いて680×150等の入力推奨です。完全レスポンシブのときは設定しても表示されません。（デフォルト状態をなるべくシンプルにするためカスタマイザーから設定しないと、このウイジェット設定は表示されません。）', 'smooth-update' );
  }
  register_sidebars(1,
    array(
    'name' => $adw_name,
  ...
  register_sidebars(1,
    array(
    'name' => __( '広告 320x100', 'smooth-update' ),
    'id' => 'adsense-320',
    'description' => __( '広告が2つしか表示されていないモバイルページのトップにラージモバイルバナーを表示します。「テキスト」ウィジェットを用いて320×100のラージモバイルバナー入力推奨です。完全レスポンシブのときは設定しても表示されません。（デフォルト状態をなるべくシンプルにするためカスタマイザーから設定しないと、このウイジェット設定は表示されません。）', 'smooth-update' ),
    'before_widget' => '',
    'after_widget' => '',
    'before_title' => '<div class="widget-ad">',
    'after_title' => '</div>',
...
//  register_sidebars(1,
//    array(
//    'name'=> __( '広告 レスポンシブ', 'smooth-update' ),
//    'id' => 'adsense-responsive',
//    'description' => __( 'レスポンシブ広告設置用のウイジェットです。', 'smooth-update' ),
//    'before_widget' => '',
//    'after_widget' => '',
//    'before_title' => '<div class="widget-ad">',
//    'after_title' => '</div>',
...
register_sidebars(1,
  array(
  'name' => __( '投稿パンくずリスト上', 'smooth-update' ),
  'id' => 'widget-over-breadcrumbs',
  'description' => __( '投稿のパンくずリスト上に表示されるウイジェット。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( '投稿タイトル上', 'smooth-update' ),
  'id' => 'widget-over-articletitle',
  'description' => __( '投稿タイトル上に表示されるウイジェット。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( '投稿本文上', 'smooth-update' ),
  'id' => 'widget-over-article',
  'description' => __( '投稿本文上に表示されるウイジェット。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( '投稿本文中', 'smooth-update' ),
  'id' => 'widget-in-article',
  'description' => __( '投稿本文中に表示されるウイジェット。文中最初のH2タグの手前に表示されます。広告が表示されている場合は、広告の下に表示されます。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( '投稿本文下', 'smooth-update' ),
  'id' => 'widget-under-article',
  'description' => __( '投稿本文下に表示されるウイジェット。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( '投稿SNSボタン上', 'smooth-update' ),
  'id' => 'widget-over-sns-buttons',
  'description' => __( '投稿のメインカラムの一番下となるSNSボタンの上に表示されるウイジェット。広告を表示している場合は、広告の下になります。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( '投稿SNSボタン下', 'smooth-update' ),
  'id' => 'widget-under-sns-buttons',
  'description' => __( '投稿のメインカラムの一番下となるSNSボタンの下に表示されるウイジェット。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( '投稿関連記事下', 'smooth-update' ),
  'id' => 'widget-under-related-entries',
  'description' => __( '関連記事の下（広告を表示している場合はその下）に表示されるウイジェット。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( '固定ページ本文上', 'smooth-update' ),
  'id' => 'widget-over-page-article',
  'description' => __( '固定ページ本文上に表示されるウイジェット。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( '固定ページ本文中', 'smooth-update' ),
  'id' => 'widget-in-page-article',
  'description' => __( '固定ページ本文中に表示されるウイジェット。文中最初のH2タグの手前に表示されます。広告が表示されている場合は、広告の下に表示されます。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( '固定ページ本文下', 'smooth-update' ),
  'id' => 'widget-under-page-article',
  'description' => __( '固定ページ本文下に表示されるウイジェット。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( '固定ページSNSボタン上', 'smooth-update' ),
  'id' => 'widget-over-page-sns-buttons',
  'description' => __( '固定ページのメインカラムの一番下となるSNSボタンの上に表示されるウイジェット。広告を表示している場合は、広告の下になります。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( '固定ページSNSボタン下', 'smooth-update' ),
  'id' => 'widget-under-page-sns-buttons',
  'description' => __( '固定ページのメインカラムの一番下となるSNSボタンの下に表示されるウイジェット。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( 'インデックスリストトップ', 'smooth-update' ),
  'id' => 'widget-index-top',
  'description' => __( 'インデックスリストのトップに表示されるウイジェット。広告が表示されているときは広告の下に表示されます。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( 'インデックスリストミドル', 'smooth-update' ),
  'id' => 'widget-index-middle',
  'description' => __( 'インデックスリストの3つ目下に表示されるウイジェット。「一覧リストのスタイル」が「サムネイルカード」の時のみの機能です。広告が表示されているときは広告の下に表示されます。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( 'インデックスリストボトム', 'smooth-update' ),
  'id' => 'widget-index-bottom',
  'description' => __( 'インデックスリストのボトムに表示されるウイジェット。広告が表示されているときは広告の下に表示されます。設定しないと表示されません。', 'smooth-update' ),
...
register_sidebars(1,
  array(
  'name' => __( 'フッター左', 'smooth-update' ),
  'id' => 'footer-left',
  'description' => __( 'フッター左側のウィジットエリアです。', 'smooth-update' ),
  'before_widget' => '<aside id="%1$s" class="widget %2$s">',
  'after_widget' => '</aside>',
...
register_sidebars(1,
  array(
  'id' => 'footer-center',
  'name' => __( 'フッター中', 'smooth-update' ),
  'description' => __( 'フッター中間のウィジットエリアです。', 'smooth-update' ),
  'before_widget' => '<aside id="%1$s" class="widget %2$s">',
  'after_widget' => '</aside>',
  'before_title' => '<h3 class="footer_widget_title">',
  'after_title' => '</h3>',
...
register_sidebars(1,
  array(
  'name' => __( 'フッター右', 'smooth-update' ),
  'id' => 'footer-right',
  'description' => __( 'フッター右側フッター中のウィジットエリアです。', 'smooth-update' ),
  'before_widget' => '<aside id="%1$s" class="widget %2$s">',
  'after_widget' => '</aside>',
  'before_title' => '<h3 class="footer_widget_title">',
  'after_title' => '</h3>',
...
register_sidebars(1,
  array(
  'name' => __( '404ページ', 'smooth-update' ),
  'id' => '404-page',
  'description' => __( '404ページをカスタマイズするためのウィジットエリアです。', 'smooth-update' ),
