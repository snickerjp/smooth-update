...
class PcDoubleAdsWidgetItem extends WP_Widget {
  function __construct() {
    parent::__construct(
      ...
      __( '[S] PC用広告ダブルレクタングル', 'smooth-update' ),
      array('description' => __( 'パソコンのみで表示されるSimplicity用のダブルレクタングル広告ウィジェットです。（※アドセンスの場合は広告コードのみを記入してください。）', 'smooth-update' ))
    );
  }
