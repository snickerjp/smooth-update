...
class SimplicityNewPopularWidgetItem extends WP_Widget {
  function __construct() {
    parent::__construct(
      'new_popular',
      __( '[S] 新着・人気記事', 'smooth-update' ),
      array('description' => __( 'トップページで「人気記事」リストを、それ以外のページで「新着記事」リストを表示するSimplicityウィジェットです。（※要Wordpress Popular Postsプラグイン）', 'smooth-update' ))
    );
  }
  ...
  function form($instance) {
    ...
    <p>
      <label for="<?php echo $this->get_field_id('title_new'); ?>">
        <?php _e( '新着記事のタイトル', 'smooth-update' ) ?>
      </label>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('is_pages_include'); ?>">
        <?php _e( '固定ページの表示（人気記事のみ）', 'smooth-update' ) ?>
      </label><br />
    ...
    <p>
      <label for="<?php echo $this->get_field_id('range'); ?>">
        <?php _e( '集計単位（人気記事のみ）', 'smooth-update' ) ?>
      </label><br />
    ...
    <p>
      <label for="<?php echo $this->get_field_id('range_visible'); ?>">
        <?php _e( '集計期間の表示（人気記事のみ）', 'smooth-update' ) ?>
      </label><br />
    ...
    <p>
      <label for="<?php echo $this->get_field_id('is_views_visible'); ?>">
        <?php _e( '閲覧数の表示（人気記事のみ）', 'smooth-update' ) ?>
      </label><br />
    ...
    <p>
      <label for="<?php echo $this->get_field_id('is_ranking_visible'); ?>">
        <?php _e( 'ランキング順位の表示（人気記事のみ）', 'smooth-update' ) ?>
      </label><br />
    ...
    <p>
       <label for="<?php echo $this->get_field_id('exclude_ids'); ?>">
        <?php _e( '除外する投稿ID（カンマ区切りで指定。※Popular Posts使用時のみ）', 'smooth-update' ) ?>
       </label>
    ...
    <p>
       <label for="<?php echo $this->get_field_id('exclude_category_ids'); ?>">
        <?php _e( '除外するカテゴリID（カンマ区切りで指定。※Popular Posts使用時のみ）', 'smooth-update' ) ?>
       </label>
