...
class FacebookSaveButtonWidgetItem extends WP_Widget {
  function __construct() {
     parent::__construct(
      ...
      __( '[S] 「Facebookに保存する」ボタンウィジェット', 'smooth-update' ),//ウイジェット名
      array('description' => __( '「Facebookに保存する」ボタンを利用して、訪問者にページをストック機能を利用してもらうためのウィジェットです。（※投稿・固定ページでしか利用できません）', 'smooth-update' ))
    );
  }
